        ...
        <table width="960" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="center">
              ...
              <form name="changepassword" id="changepassword" method="post" action="update_password.php">

                <table width="300" border="0" cellspacing="2" cellpadding="2">
                  <tr class="labels">
                    <td nowrap="nowrap">Old Password</td>
                    <td nowrap="nowrap"><label for="tbOldPass"></label>
                      <input type="password" name="oldpassword" id="oldpassword" class="textFields" />
                    </td>
                  </tr>
                  <tr class="labels">
                    <td nowrap="nowrap">New Password</td>
                    <td nowrap="nowrap"><input type="password" name="newpassword" id="newpassword" class="textFields" /></td>
                  </tr>
                  <tr class="labels">
                    <td nowrap="nowrap">Again Password</td>
                    <td nowrap="nowrap"><input type="password" name="againpassword" id="againpassword" class="textFields" /></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td align="right"><input type="submit" name="button" id="button" value="Update Password" class="btns" /></td>
                  </tr>
                </table>
