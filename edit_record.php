                ...
                <table width="960" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <form id="add_contacts" name="add_contacts" method="post" action="update_record.php" onsubmit="return validateForm()">
                                ...
                                <table width="300" border="0" cellspacing="2" cellpadding="2">
                                    ...
                                    <tr class="labels">
                                        ...
                                        <td nowrap="nowrap"><input type="text" name="fullname" id="fullname" class="textFields" value="<?php echo $row['fullname']  ?>" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="labels">
                                        ...
                                        <td nowrap="nowrap">
                                            <select name="country" id="country" class="textFields">
                                                ...
                                                ?>
                                                    <option value="<?php echo $viewcountry['id']; ?>" <?php echo ($viewcountry['id'] == $row['country']) ? 'selected' : ''; ?>><?php echo $viewcountry['name']; ?> </option>
                                                <?php  } ?>
                                            </select>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="labels">
                                        ...
                                        <td nowrap="nowrap"><input type="text" name="company" id="company" class="textFields" value="<?php echo $row['company']  ?>" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="labels">
                                        ...
                                        <td nowrap="nowrap"><input type="text" name="designation" id="designation" class="textFields" value="<?php echo $row['designation']  ?>" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="labels">
                                        ...
                                        <td nowrap="nowrap"><input type="text" name="phone" id="phone" class="textFields" value="<?php echo $row['phone']  ?>" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="labels">
                                        ...
                                        <td nowrap="nowrap"><input type="text" name="mobile" id="mobile" class="textFields" value="<?php echo $row['mobile']  ?>" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="labels">
                                        ...
                                        <td nowrap="nowrap"><input type="text" name="email" id="email" class="textFields" value="<?php echo $row['email']  ?>" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="labels">
                                        ...
                                        <td nowrap="nowrap">
                                            <select name="cp_group" id="cp_group" class="textFields">
                                                <option value="" <?php echo ($row['cp_group'] == 'none') ? 'selected' : ''; ?>>-- Select group --</option>
                                                <option value="group 1" <?php echo ($row['cp_group'] == 'group 1') ? 'selected' : '';     ?>>group 1</option>
                                                <option value="group 2" <?php echo ($row['cp_group'] == 'group 2') ? 'selected' : '';     ?>>group 2</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="labels">
                                        ...
                                        <td nowrap="nowrap"><textarea name="address" id="address" cols="39" rows="5"><?php echo $row['address']  ?></textarea></td>
                                    </tr>
                                    <tr>
