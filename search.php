          ...
          <tr>
            ...
            <td align="center">
              <table width="300" border="0" cellspacing="2" cellpadding="2">
                <tr class="labels">
                  <td nowrap="nowrap">Search Record:</td>
                  <td nowrap="nowrap"><label for="textfield"></label>
                    <input type="text" name="textfield" id="textfield" class="textFields" />
                  </td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td align="right"><input type="submit" name="button" id="button" value="Search" class="btns" /></td>
                </tr>
              </table>
            </td>
