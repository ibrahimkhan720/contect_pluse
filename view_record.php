            ...
            <td valign="top">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  $query = mysqli_query($connection, "SELECT * from record WHERE member_id=$member_id AND status='ACTIVE' ") or die(mysqli_error($connection));
                  while ($row = mysqli_fetch_array($query)) {

                  ?>
                    <td style="width:35%;"><?php echo $row['fullname'] ?></td>
                    <td style="width:25%;"><?php echo $row['company'] ?></td>
                    <td style="width:25%;"><?php echo $row['email'] ?></td>
                    <td style="width:10%;"><a href="edit_record.php?id=<?php echo $row['id']  ?>">Edit </a> | <a href="delet_record.php?id=<?php echo $row['id']  ?>">Delet</a>
                </tr>
